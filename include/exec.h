 ...
 */
#define RSH_PIPE_NONE    0x00
#define RSH_PIPE_IN      0x01
#define RSH_PIPE_OUT     0x02
#define RSH_PIPE_ERR     0x04
#define RSH_PIPE_IN_OUT  (RSH_PIPE_IN|RSH_PIPE_OUT)
#define RSH_PIPE_IN_ERR  (RSH_PIPE_IN|RSH_PIPE_ERR)
